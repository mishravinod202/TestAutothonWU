...
TOKEN = 'cglbn7QVeZAAAAAAAAABI7G9u53E36yt7Bz4ztFk0UabE0WGLdtR_grTXku2SFMr'

parser = argparse.ArgumentParser(description='Sync ~/Desktop/abcd.txt to Dropbox')
parser.add_argument('folder', nargs='?', default='Desktop',
